      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-16 py-4">
          ...
          <div className="flex-1 text-center lg:text-left max-w-xl">
            ...
            {/* Top Minimal Pill Tag (Clean without emote love) */}
            ...
            {/* Academic Info Card with Official UNSIL Logo */}
            <div className="inline-flex flex-col sm:flex-row items-center lg:items-start gap-2 sm:gap-4 p-3.5 sm:px-5 sm:py-3 rounded-2xl bg-white/80 dark:bg-slate-800/80 border border-rose-100 dark:border-slate-700/80 shadow-sm backdrop-blur-sm">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-white dark:bg-slate-800 p-1 flex items-center justify-center shadow-xs flex-shrink-0 border border-rose-100 dark:border-slate-700">
                  <img src="./assets/logo-unsil.png" alt="Logo Universitas Siliwangi" className="w-full h-full object-contain" />
                </div>
